...
namespace Utilities.WPF.Behaviors
{
    ...
    public class VisibilityAnimation
    {
        ...
        /// Animation duration
        /// </summary>
        private const int AnimationDuration = 145;
        ...
        public static AnimationType GetAnimationType(DependencyObject obj) => (AnimationType)obj.GetValue(AnimationTypeProperty);
        ...
        public static void SetAnimationType(DependencyObject obj, AnimationType value) => obj.SetValue(AnimationTypeProperty, value);
        ...
        private static void HookVisibilityChanges(FrameworkElement frameworkElement) => _hookedElements.Add(frameworkElement, false);
        ...
        private static bool IsHookedElement(FrameworkElement frameworkElement) => _hookedElements.ContainsKey(frameworkElement);
        ...
        {
            _hookedElements[frameworkElement] = !_hookedElements[frameworkElement];

            return _hookedElements[frameworkElement];
        }
    }
}
